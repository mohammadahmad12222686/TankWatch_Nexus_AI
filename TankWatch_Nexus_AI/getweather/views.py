...
def show_weather_data(date_w,time_w,pincode_w):
    ...
    #url="https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/forecast?locations=Delhi,IN&aggregateHours=24&unitGroup=us&shortColumnNames=false&contentType=csv&key=PQ6T4N7XPRBXVXWYJN9YZ829K"
    #url="https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/weatherdata/forecast?locations=D,VA,20170&aggregateHours=24&unitGroup=us&shortColumnNames=false&contentType=csv&key=YOURAPIKEY"
    try:
        if(time_to_ind>17):
